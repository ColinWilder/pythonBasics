# LPP: Latin Phrase Processor
# September 28, 2017

# Notes
# Formerly called CTP (Catalog Title Processor), named for its first application - the processing of titles in historic library catalogs. 
# This is version 4. The versions are just convenient stopping points in development, each representing a more or less stable, functioning code base. 
