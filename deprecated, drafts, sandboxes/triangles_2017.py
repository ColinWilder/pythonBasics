...
Looks like I created this in about 2016-2017 while writing the Nijmegen library collections article (later for pub in NTMRS). Don't really know IP of it - probaboy 90% of it is not my own. Not sure where I got the triangle idea from.
This file needs to be superseded and simplified. Right now it combines the functions of looking for a CSV source file in a folder, opening it, reading all the bigrams and ther frequencies in it, figuring out triangles and their weights, and writing a new CSV file with the latter information. It is super messy.
So I'm going to stop editing on this and make a new version of it marked with today's date 3/31/21 which just receives a list of bigrams and finds triangles and their weights. 
"""
